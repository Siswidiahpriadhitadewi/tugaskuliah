...
System.out.println("===============================================");
 ...
 Mahasiswa m1 = new Mahasiswa("20001","Thalhah","021xxx"); Mahasiswa 
m2 = new Mahasiswa("20002","Zubair","021xxx");
...
int idxMhs = Collections.binarySearch(am, new 
Mahasiswa(nim,null,null), Mahasiswa.MhsNimCom);
 int idxMk = Collections.binarySearch(amk,new 
MataKuliah(kode,null,null),MataKuliah.ComMkKode);
 Nilai n = new 
Nilai(am.get(idxMhs),amk.get(idxMk),nilai);
 an.add(n);
break;
 case 2:
...
System.out.println("NIM\t\tNama\t\tMata Kuliah\t\t\tSKS\tNilai");
 for (Nilai ni: an) {
 System.out.println(ni.mahasiswa.nim+"\t"+ 
ni.mahasiswa.nama+"\t\t"+ ni.mk.matkul+"\t\t"+ ni.mk.sks+"\t"+ ni.nilai);
 }
break;
     case 3:
 System.out.println("DAFTAR NILAI MAHASISWA");
...
System.out.println(nilaiNim.mahasiswa.nim+"\t"+ 
nilaiNim.mahasiswa.nama+"\t\t"+ nilaiNim.mk.matkul+"\t\t"+ 
nilaiNim.mk.sks+"\t"+ nilaiNim.nilai);
 }
 }
