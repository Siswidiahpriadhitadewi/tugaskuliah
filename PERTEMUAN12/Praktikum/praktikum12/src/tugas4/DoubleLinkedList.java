...
public class DoubleLinkedList {
 ...
 public void add(String nim, String nama, double ipk, int index) { if (isEmpty()) {
     addFirst(nim, nama, ipk);
     ...
     Node newNode = new Node(null, nim, nama, ipk, 
    current);
     current.prev = newNode;
     newNode = head;
     } else {
     Node newNode = new Node(current.prev, nim, nama, 
    ipk, current);
